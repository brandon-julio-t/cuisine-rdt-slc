...
const DetailPopUp: FunctionComponent<
  HTMLAttributes<HTMLDivElement> & { food: Food | null }
> = ({ food, className, ...rest }) => {
  ...
  return (
    <div
      {...rest}
      className={`max-w-prose mx-2 lg:mx-auto rounded-t-lg overflow-hidden ${className}`}>
      <Transition
        show={isShowPopup}
